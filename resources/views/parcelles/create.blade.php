...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;}
        ...
        .card-band{padding:1.5rem 1.75rem;color:#fff;background:var(--forest-700);}
        ...
        .field input:focus,.field select:focus{outline:2px solid var(--forest-700);outline-offset:1px;background:#fff;}
...
<div class="page">
    ...
    <div class="card">
        ...
        <div class="card-band">
            <h1><i class="bi bi-plus-circle"></i> Ajouter une parcelle</h1>
            <p>Créer une nouvelle fiche parcelle</p>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('parcelles.store') }}" method="POST">
                ...
                <div class="field">
                    <label>Nom</label>
                    <input type="text" name="nom" class="form-control" placeholder="Ex : Parcelle Nord">
                </div>

                <div class="field">
                    <label>Culture</label>
                    <input type="text" name="culture" class="form-control" placeholder="Ex : Oliviers">
                </div>

                <div class="field">
                    <label>Superficie (ha)</label>
                    <input type="number" step="0.01" name="superficie" class="form-control" placeholder="0.00">
                </div>
